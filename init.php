...
function obywie_attraction_modifymenu() {
	...
	add_menu_page('Attraction', //page title
	'Attraction List', //menu title
	...
	//this is a submenu
	add_submenu_page('obywie_attraction_list', //parent slug
	'Add New Attraction', //page title
	'Add New', //menu title
	'manage_options', //capability
	'obywie_attraction_create', //menu slug
	'obywie_attraction_create'); //function
	...
	'obywie_attraction_update'); //function	
	...
	'obywie_attraction_delete'); //function
}
...
require_once(ROOTDIR . 'obywieattr-list.php');
require_once(ROOTDIR . 'obywieattr-create.php');
require_once(ROOTDIR . 'obywieattr-update.php');
